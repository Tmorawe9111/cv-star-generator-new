              ...
              {formData.sprachen?.map((sprache, index) => {
                ...
                return (
                  <div key={index} className="flex gap-2 items-start">
                    ...
                    <Button type="button" variant="ghost" size="sm" onClick={() => removeSprache(index)}>
              ...
              {(formData.qualifikationen?.length || 0) === 0 ? (
                ...
                formData.qualifikationen?.map((qual, index) => (
                  <div key={index} className="flex gap-2">
                    ...
                    />
                    <Button type="button" variant="ghost" size="sm" onClick={() => removeQualifikation(index)}>
                      <Trash2 className="h-4 w-4" />
                    </Button>
                  </div>
                ))
              ...
              {(formData.zertifikate?.length || 0) === 0 ? (
                ...
                formData.zertifikate?.map((zert, index) => (
                  <div key={index} className="flex gap-2">
                    ...
                    />
                    <Button type="button" variant="ghost" size="sm" onClick={() => removeZertifikat(index)}>
                      <Trash2 className="h-4 w-4" />
                    </Button>
                  </div>
                ))
              ...
              {(formData.interessen?.length || 0) === 0 ? (
                ...
                formData.interessen?.map((interesse, index) => (
                  <div key={index} className="flex gap-2">
                    ...
                    />
                    <Button type="button" variant="ghost" size="sm" onClick={() => removeInteresse(index)}>
                      <Trash2 className="h-4 w-4" />
                    </Button>
                  </div>
                ))
