...
interface Step3DetailsLocationProps {
  data: OnboardingData;
...
export function Step3DetailsLocation({ data, onUpdate, onNext, onBack }: Step3DetailsLocationProps) {
  ...
  const isValid = () => {
    return !!data.industry && !!data.city && !!data.zipCode && !!data.country && !!data.street && !!data.streetNumber;
  };
    ...
    <div className="flex flex-col h-full space-y-8 overflow-hidden">
      ...
      <div className="text-center space-y-3 flex-shrink-0">
        ...
        <p className="text-lg text-gray-600 leading-relaxed">
          Geben Sie uns einige Informationen über Ihr Unternehmen
        </p>
      </div>
      ...
      <div className="flex-1 space-y-6 overflow-y-auto min-h-0 pr-2">
        ...
        <div className="space-y-2">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
            {BRANCHES.map((branch) => (
              <Card
                key={branch.key}
                className={`p-4 cursor-pointer transition-all duration-300 ease-out rounded-xl hover:shadow-sm hover:scale-[1.02] active:scale-[0.98] ${
              ...
              >
                <div className="text-center">
                  <h3 className="text-sm font-medium mb-1.5">{branch.label}</h3>
        ...
        <div className="space-y-4">
          <Label className="text-base font-medium">Hauptstandort</Label>
          ...
          <div className="grid grid-cols-3 gap-4">
            ...
            <div className="space-y-2">
              <Label htmlFor="streetNumber" className="text-sm">
                Nr. *
              </Label>
              <Input
                id="streetNumber"
